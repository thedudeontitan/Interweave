    ...
    return (
        <div className="min-h-screen flex w-full ">
            <div className='flex flex-col items-start my-auto px-5 lg:px-20 gap-4 lg:gap-10 lg:w-[70vw]'>
                ...
                The Future of APIs and Oracles is Connected with <span className='text-transparent font-semibold text-5xl lg:text-[6vw] text-stroke-DEFAULT lg:text-stroke-lg'>Interweave</span>
                </div>
